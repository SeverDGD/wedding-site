...
// Отправка формы на почту (без сервера через FormSubmit)
document.getElementById('guestForm').setAttribute('action', 'https://formsubmit.co/vitalavolikov@gmail.com');
document.getElementById('guestForm').setAttribute('method', 'POST');
